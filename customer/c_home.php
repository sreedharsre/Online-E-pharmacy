        ...
        <div class="container">
            ...
            <section class="content">
                <div class="grid-container">
                    ...
                    <div class="grid-ite">
                        <a href="profile.php"><b>View Profile</b></a>
                    </div>
                    <div class="grid-ite">
                        <a href="medicine.php"><b>Order Something</b></a>
                    </div>
                    <div class="grid-ite">
                        <a href="orders.php"><b>Tracking Status</b></a>
                    </div>
                    ...
                    <div class="grid-ite">
                        <a href="view_cart.php"><b>Manage Cart</b></a>
                    </div>
                    <div class="grid-ite">
                        <a href="orders.php"><b>Print Invoice</b></a>
                    </div>
                    <div class="grid-ite">
