...
// Fetch invoice details based on the session username
$invoiceDetails = null;

if ($stmt = $conn->prepare("SELECT INVOICE_ID, NET_TOTAL, INVOICE_DATE, TOTAL_AMOUNT, Tracking, Name FROM invoices WHERE Name = ?")) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $invoiceDetails = "No record found for user: " . htmlspecialchars($userid);
    }
    $stmt->close();
} else {
